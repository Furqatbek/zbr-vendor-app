...
export const mockRevenueData: RevenueData = {
  ...
  topItems: [
    { rank: 1, name: 'Classic Burger', unitsSold: 45, revenue: 584.55 },
    { rank: 2, name: 'Double Cheeseburger', unitsSold: 32, revenue: 511.68 },
    { rank: 3, name: 'Fries Large', unitsSold: 38, revenue: 189.62 },
    { rank: 4, name: 'BBQ Bacon Burger', unitsSold: 28, revenue: 419.72 },
    { rank: 5, name: 'Cola', unitsSold: 52, revenue: 155.48 },
  ],
  refunds: 3,
  cancellations: 5,
};
