export default {
  ...
  reports: {
    ...
    deliverySubsidies: 'Delivery Subsidies',
    promotionCosts: 'Promotions',
    fees: 'Fees',
    netPayout: 'Net Payout',
    pendingPayouts: 'Pending',
    completedPayouts: 'Completed',
    payoutTrend: 'Payout Trend',
  ...
  payments: {
    ...
    failedToLoad: 'Failed to load payouts',
  ...
  deleteAccount: {
    ...
    intro: 'This permanently deletes your ZBR partner account and everything linked to it.',
    introWithRestaurant: 'This permanently deletes your ZBR partner account and removes {{restaurant}} from the platform.',
    whatHappens: 'What happens',
    consequenceOrders: 'You stop receiving orders immediately.',
    consequenceListing: 'Your restaurant is removed from the ZBR app for customers.',
    consequenceAccess: 'You lose access to your menu, reports and payout history.',
    consequenceRecords: 'Financial records we must keep by law are retained, but no longer linked to a usable account.',
    ...
    finalTitle: 'Delete account?',
    finalMessage: 'Your account and restaurant will be permanently deleted. This cannot be undone.',
    confirmDelete: 'Delete',
    failedTitle: 'Could not delete account',
    failedMessage: 'Something went wrong. Please try again, or contact support.',
    contactSupport: 'Contact support',
    emailSubject: 'Account deletion request',
    helper: 'Deletion is processed by ZBR. If anything is still pending on your account, support may contact you first.',
  },
} as const;
